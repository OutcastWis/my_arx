...
namespace wzj {
    ...
    namespace detail{
         ...
         * 写入后为:
         *      计算机\\HKEY_CURRENT_USER\\SOFTWARE\\Autodesk\\AutoCAD\\R22.0\\ACAD-1001:804\\Applications
         *          cmd_count       对应setAppName
         *              Commands   对应writeCommandNameToRegistry
         *              Groups      对应writeGroupNameToRegistry
         * 
         */
        void updateRegistry()
        {
